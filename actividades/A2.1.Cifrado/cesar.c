...
void encriptar(FILE *archivo, char aN[])
{
...
void desencriptar(FILE *archivo, char aN[])
{
  //creamos archivo con el resultado encriptado
...
int main(int argc, char **argv)
{
  ...
  ordenamiento(abecedario, desp, na);

  //ejecuta seleccion del usuario
  if(seleccion == 1)
    encriptar(archivo, na);
  else
    desencriptar(archivo, na);
